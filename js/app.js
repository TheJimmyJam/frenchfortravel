...
const UI_STRINGS = {
  ...
  el: {
    nav_lesson:'Σημερινό Μάθημα', nav_flashcards:'Κάρτες Μνήμης', nav_quiz:'Κουίζ',
    nav_all:'Όλα τα Μαθήματα', nav_conversations:'Συνομιλίες', nav_translator:'Μεταφραστής',
    nav_notebook:'Σημειωματάριο', nav_progress:'Πρόοδος',
    lesson_day:(n)=>`Ημέρα ${n}`, lesson_badge:'🏆 Μάθημα ολοκληρώθηκε!',
    lesson_complete:'Σήμανση ολοκλήρωσης', lesson_incomplete:'Σήμανση ως ημιτελές',
    lesson_tip:'💡 Συμβουλή:', lesson_cultural:'🌍 Πολιτιστική Σημείωση:',
    fc_front:'Εμπρός', fc_back:'Πίσω', fc_flip:'Αναποδογύρισμα',
    fc_prev:'Προηγούμενο', fc_next:'Επόμενο', fc_empty:'Δεν υπάρχουν κάρτες μνήμης ακόμα.',
    fc_add_trans:'Αποθήκευση μεταφράσεων', fc_study:'Μελέτη αποθηκευμένων λέξεων',
    quiz_check:'Έλεγχος', quiz_next:'Επόμενο', quiz_score:(c,t)=>`Βαθμός: ${c}/${t}`,
    quiz_empty:'Ολοκληρώστε μαθήματα για να ξεκινήσετε κουίζ.',
    all_title:'Όλα τα Μαθήματα', all_completed:'ολοκληρώθηκαν',
    prog_title:'Η Πρόοδός Σας', prog_completed:'Ημέρες που ολοκληρώθηκαν',
    prog_streak:'Σερί', prog_days:'ημέρες',
    trans_title:'Μεταφραστής',
    trans_subtitle:(tg)=>`Μεταφράστε στα ${tg}. Λάβετε μετάφραση, IPA και οδηγό προφοράς.`,
    trans_subtitle_cross:(s,tg)=>`Μεταφράστε από τα ${s} στα ${tg}. Λάβετε μετάφραση, IPA και οδηγό προφοράς.`,
    trans_placeholder:'Πληκτρολογήστε κείμενο για μετάφραση...',
    trans_btn:'Μετάφραση', trans_ipa:'Προφορά (IPA):', trans_guide:'Οδηγός Προφοράς:',
    trans_save:'Αποθήκευση στις Κάρτες Μνήμης', trans_tip:'Συμβουλή μεταφραστή:',
    trans_tip_text:'Δοκιμάστε να μεταφράσετε πλήρεις φράσεις για καλύτερα αποτελέσματα.',
    trans_saved_cards:'Αποθηκευμένες κάρτες:', trans_recent:'Πρόσφατα',
    trans_error:'Αποτυχία μετάφρασης:',
    toast_added_review:'📍 Προστέθηκε στην ουρά επανάληψης',
    toast_removed:'Αφαιρέθηκε από τις κάρτες μνήμης', toast_saved:'✓ Αποθηκεύτηκε στις κάρτες μνήμης',
    toast_day_incomplete:(n)=>`Ημέρα ${n} επισημάνθηκε ως ημιτελής.`,
  },
  de: {
    nav_lesson:'Heutige Lektion', nav_flashcards:'Lernkarten', nav_quiz:'Quiz',
    nav_all:'Alle Lektionen', nav_conversations:'Gespräche', nav_translator:'Übersetzer',
    nav_notebook:'Notizbuch', nav_progress:'Fortschritt',
    lesson_day:(n)=>`Tag ${n}`, lesson_badge:'🏆 Lektion abgeschlossen!',
    lesson_complete:'Als abgeschlossen markieren', lesson_incomplete:'Als unvollständig markieren',
    lesson_tip:'💡 Tipp:', lesson_cultural:'🌍 Kultureller Hinweis:',
    fc_front:'Vorderseite', fc_back:'Rückseite', fc_flip:'Umdrehen',
    fc_prev:'Vorherige', fc_next:'Nächste', fc_empty:'Noch keine Lernkarten.',
    fc_add_trans:'Übersetzungen speichern', fc_study:'Gespeicherte Wörter lernen',
    quiz_check:'Prüfen', quiz_next:'Weiter', quiz_score:(c,t)=>`Punkte: ${c}/${t}`,
    quiz_empty:'Schließe Lektionen ab, um das Quiz zu starten.',
    all_title:'Alle Lektionen', all_completed:'abgeschlossen',
    prog_title:'Ihr Fortschritt', prog_completed:'Abgeschlossene Tage',
    prog_streak:'Serie', prog_days:'Tage',
    trans_title:'Übersetzer',
    trans_subtitle:(tg)=>`Übersetze ins ${tg}. Erhalte Übersetzung, IPA und Ausspracheführer.`,
    trans_subtitle_cross:(s,tg)=>`Übersetze von ${s} nach ${tg}. Erhalte Übersetzung, IPA und Ausspracheführer.`,
    trans_placeholder:'Text zum Übersetzen eingeben...',
    trans_btn:'Übersetzen', trans_ipa:'Aussprache (IPA):', trans_guide:'Ausspracheführer:',
    trans_save:'In Lernkarten speichern', trans_tip:'Übersetzer-Tipp:',
    trans_tip_text:'Versuche ganze Sätze zu übersetzen für bessere Ergebnisse.',
    trans_saved_cards:'Gespeicherte Karten:', trans_recent:'Zuletzt',
    trans_error:'Übersetzung fehlgeschlagen:',
    toast_added_review:'📍 Zur Wiederholungswarteschlange hinzugefügt',
    toast_removed:'Aus Lernkarten entfernt', toast_saved:'✓ In Lernkarten gespeichert',
    toast_day_incomplete:(n)=>`Tag ${n} als unvollständig markiert.`,
  },
  ja: {
    nav_lesson:'今日のレッスン', nav_flashcards:'フラッシュカード', nav_quiz:'クイズ',
    nav_all:'全レッスン', nav_conversations:'会話', nav_translator:'翻訳',
    nav_notebook:'ノート', nav_progress:'進捗',
    lesson_day:(n)=>`${n}日目`, lesson_badge:'🏆 レッスン完了！',
    lesson_complete:'完了にする', lesson_incomplete:'未完了にする',
    lesson_tip:'💡 ヒント：', lesson_cultural:'🌍 文化メモ：',
    fc_front:'表', fc_back:'裏', fc_flip:'裏返す',
    fc_prev:'前へ', fc_next:'次へ', fc_empty:'フラッシュカードはまだありません。',
    fc_add_trans:'翻訳を保存', fc_study:'保存した単語を学習',
    quiz_check:'確認', quiz_next:'次へ', quiz_score:(c,t)=>`スコア：${c}/${t}`,
    quiz_empty:'クイズを始めるにはレッスンを完了してください。',
    all_title:'全レッスン', all_completed:'完了',
    prog_title:'あなたの進捗', prog_completed:'完了した日数',
    prog_streak:'連続', prog_days:'日',
    trans_title:'翻訳',
    trans_subtitle:(tg)=>`${tg}に翻訳します。翻訳・IPA・発音ガイドを取得します。`,
    trans_subtitle_cross:(s,tg)=>`${s}から${tg}に翻訳します。翻訳・IPA・発音ガイドを取得します。`,
    trans_placeholder:'翻訳するテキストを入力...',
    trans_btn:'翻訳', trans_ipa:'発音（IPA）：', trans_guide:'発音ガイド：',
    trans_save:'フラッシュカードに保存', trans_tip:'翻訳のヒント：',
    trans_tip_text:'より良い結果を得るために完全な文を翻訳してみてください。',
    trans_saved_cards:'保存したカード：', trans_recent:'最近',
    trans_error:'翻訳に失敗しました：',
  ...
  ko: {
    nav_lesson:'오늘의 레슨', nav_flashcards:'플래시카드', nav_quiz:'퀴즈',
    nav_all:'전체 레슨', nav_conversations:'대화', nav_translator:'번역기',
    nav_notebook:'노트', nav_progress:'진행 상황',
    lesson_day:(n)=>`${n}일차`, lesson_badge:'🏆 레슨 완료!',
    lesson_complete:'완료로 표시', lesson_incomplete:'미완료로 표시',
    lesson_tip:'💡 팁:', lesson_cultural:'🌍 문화 메모:',
    fc_front:'앞면', fc_back:'뒷면', fc_flip:'뒤집기',
    fc_prev:'이전', fc_next:'다음', fc_empty:'플래시카드가 아직 없습니다.',
    fc_add_trans:'번역 저장', fc_study:'저장된 단어 학습',
    quiz_check:'확인', quiz_next:'다음', quiz_score:(c,t)=>`점수: ${c}/${t}`,
    quiz_empty:'퀴즈를 시작하려면 레슨을 완료하세요.',
    all_title:'전체 레슨', all_completed:'완료',
    prog_title:'나의 진행 상황', prog_completed:'완료한 날',
    prog_streak:'연속', prog_days:'일',
    trans_title:'번역기',
    trans_subtitle:(tg)=>`${tg}(으)로 번역합니다. 번역, IPA 및 발음 가이드를 받으세요.`,
    trans_subtitle_cross:(s,tg)=>`${s}에서 ${tg}(으)로 번역합니다. 번역, IPA 및 발음 가이드를 받으세요.`,
    trans_placeholder:'번역할 텍스트를 입력하세요...',
    trans_btn:'번역', trans_ipa:'발음 (IPA):', trans_guide:'발음 가이드:',
    trans_save:'플래시카드에 저장', trans_tip:'번역기 팁:',
    trans_tip_text:'더 나은 결과를 위해 완전한 문장을 번역해 보세요.',
  ...
  sq: {
    nav_lesson:'Mësimi i Sotëm', nav_flashcards:'Kartela Memorie', nav_quiz:'Kuiz',
    nav_all:'Të gjitha Mësimet', nav_conversations:'Biseda', nav_translator:'Përkthyes',
    nav_notebook:'Bllok Shënimesh', nav_progress:'Progresi',
    lesson_day:(n)=>`Dita ${n}`, lesson_badge:'🏆 Mësimi u përfundua!',
    lesson_complete:'Shëno si të përfunduar', lesson_incomplete:'Shëno si të papërfunduar',
    lesson_tip:'💡 Këshillë:', lesson_cultural:'🌍 Shënim Kulturor:',
    fc_front:'Përpara', fc_back:'Prapa', fc_flip:'Ktheje',
    fc_prev:'Mëparshme', fc_next:'Tjetra', fc_empty:'Ende nuk ka kartela memorie.',
    fc_add_trans:'Ruaj përkthimet', fc_study:'Studjo fjalët e ruajtura',
    quiz_check:'Kontrollo', quiz_next:'Tjetra', quiz_score:(c,t)=>`Pikë: ${c}/${t}`,
    quiz_empty:'Përfundo mësimet për të filluar kuizin.',
    all_title:'Të gjitha Mësimet', all_completed:'të përfunduara',
    prog_title:'Progresi Juaj', prog_completed:'Ditë të përfunduara',
    prog_streak:'Seri', prog_days:'ditë',
    trans_title:'Përkthyes',
    trans_subtitle:(tg)=>`Përktheni në ${tg}. Merrni përkthimin, IPA dhe udhëzuesin e shqiptimit.`,
    trans_subtitle_cross:(s,tg)=>`Përktheni nga ${s} në ${tg}. Merrni përkthimin, IPA dhe udhëzuesin e shqiptimit.`,
    trans_placeholder:'Shkruani tekstin për ta përkthyer...',
    trans_btn:'Përkthe', trans_ipa:'Shqiptimi (IPA):', trans_guide:'Udhëzuesi i Shqiptimit:',
    trans_save:'Ruaj në Kartela Memorie', trans_tip:'Këshillë për Përkthyesin:',
    trans_tip_text:'Provoni të përktheni fjali të plota për rezultate më të mira.',
    trans_saved_cards:'Kartela të ruajtura:', trans_recent:'Të fundit',
    trans_error:'Dështimi i përkthimit:',
    toast_added_review:'📍 Shtuar në radhën e rishikimit',
    toast_removed:'Hequr nga kartelat e memorjes', toast_saved:'✓ Ruajtur në kartelat e memorjes',
    toast_day_incomplete:(n)=>`Dita ${n} u shënua si e papërfunduar.`,
  },
};
